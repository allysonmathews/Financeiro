...
export default function CVTScreen() {
  ...
  const pctFranqueado = fechamento?.pctFranqueado ?? fechamento?.pctFranquia ?? 40;
  ...
  return (
    <View style={styles.root}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 8 }]}>
        ...
        <Text style={styles.headerTitle}>CVT</Text>
      ...
      <Text style={styles.subtitle}>Dashboard · Condomínio Vila Tropical</Text>
        ...
        >
          ...
          {!fechamento ? (
            <View style={styles.emptyWrap}>
              ...
              <Text style={styles.emptySubtext}>Use o chat na Home com "Fechamento CVT [mês] [ano]" para gerar.</Text>
            </View>
          ) : (
